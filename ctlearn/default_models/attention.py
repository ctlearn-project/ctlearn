...
def squeeze_excite_block(inputs, ratio=16, trainable=True, waveform=False, name=None):
    ...
    sse = spatial_squeeze_excite_block(
        inputs=inputs, trainable=trainable, waveform=waveform, name=name + "_sse"
    )
...
def channel_squeeze_excite_block(
    inputs, ratio=4, trainable=True, waveform=False, name=None
):
...
def spatial_squeeze_excite_block(inputs, trainable=True, waveform=False, name=None):
