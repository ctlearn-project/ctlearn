...
# Convolution, Batch Normalization, and Activation Layer
...
class SqueezeExcitation(nn.Module):
    def __init__(self, n_in, reduction_factor=4):
        super(SqueezeExcitation, self).__init__()
        reduced_dim = n_in // reduction_factor
...
# Mobile Inverted Residual Block with Squeeze and Excitation
class MBConvN(nn.Module):
    def __init__(self, n_in, n_out, k_size=3, stride=1, expansion_factor=4, reduction_factor=4, survival_prob=0.8):
        ...
        self.se = SqueezeExcitation(expanded_dim, reduction_factor)
...
# Dual Backbone EfficientNetV2 Model for Specific Tasks
class DualBackboneEfficientNetV2(nn.Module):
    ...
    def forward(self, x1, x2):
        ...
        # Optionally handle a classification task
...
#     model = DualBackboneEfficientNetV2(task='energy', version='s', num_classes=1, in_channels_1=3, in_channels_2=3)  # num_classes=1 for regression