...
class NFNet(nn.Module):
    def __init__(self, num_channels=1,num_classes:int=2, variant:str='F0', stochdepth_rate:float=0.25, 
        ...
        block_args = zip(
            ...
            [57] * 4, # group pattern. Original groups [128] * 4
...
class Stem(nn.Module):
    def __init__(self, num_channels=1, activation:str='gelu'):
        super(Stem, self).__init__()
        
        self.activation = activations_dict[activation]
        self.conv0 = WSConv2D(in_channels=num_channels, out_channels=16, kernel_size=3, stride=2)
