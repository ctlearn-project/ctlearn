...
class DLFrameWork(Tool):
    ...
    try:
        from pytorch_ctlearn.ctlearn.ctlearn.tools.pytorch.train_pytorch_model import TrainPyTorchModel
        aliases.update(TrainPyTorchModel.aliases)
    except ImportError:
        pass
        
    try:
        from pytorch_ctlearn.ctlearn.ctlearn.tools.keras.train_model import TrainKerasModel
    ...
    def get_framework(cls, framework_type: FrameworkType):
        ...
        if framework_type == FrameworkType.KERAS:
            ...
            try:
                from pytorch_ctlearn.ctlearn.ctlearn.tools.pytorch.train_pytorch_model import (
                    TrainPyTorchModel,
                )
